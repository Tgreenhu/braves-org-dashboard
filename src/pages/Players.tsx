...
const HITTER_COLUMNS: { key: keyof HitterSeasonStats; label: string; numeric?: boolean; fmt?: (v: number) => string }[] = [
  ...
  { key: 'avg', label: 'AVG', numeric: true, fmt: (v) => (v == null ? '—' : v.toFixed(3)) },
  { key: 'obp', label: 'OBP', numeric: true, fmt: (v) => (v == null ? '—' : v.toFixed(3)) },
  { key: 'slg', label: 'SLG', numeric: true, fmt: (v) => (v == null ? '—' : v.toFixed(3)) },
  { key: 'ops', label: 'OPS', numeric: true, fmt: (v) => (v == null ? '—' : v.toFixed(3)) },
  { key: 'wrcPlus', label: 'wRC+', numeric: true },
  { key: 'bbPct', label: 'BB%', numeric: true, fmt: (v) => (v == null ? '—' : `${v.toFixed(1)}%`) },
  { key: 'kPct', label: 'K%', numeric: true, fmt: (v) => (v == null ? '—' : `${v.toFixed(1)}%`) },
...
const PITCHER_COLUMNS: { key: keyof PitcherSeasonStats; label: string; numeric?: boolean; fmt?: (v: number) => string }[] = [
  ...
  { key: 'ip', label: 'IP', numeric: true, fmt: (v) => (v == null ? '—' : v.toFixed(1)) },
  { key: 'era', label: 'ERA', numeric: true, fmt: (v) => (v == null ? '—' : v.toFixed(2)) },
  { key: 'fip', label: 'FIP', numeric: true, fmt: (v) => (v == null ? '—' : v.toFixed(2)) },
  { key: 'siera', label: 'SIERA', numeric: true, fmt: (v) => (v == null ? '—' : v.toFixed(2)) },
  { key: 'whip', label: 'WHIP', numeric: true, fmt: (v) => (v == null ? '—' : v.toFixed(2)) },
  { key: 'kPct', label: 'K%', numeric: true, fmt: (v) => (v == null ? '—' : `${v.toFixed(1)}%`) },
  { key: 'bbPct', label: 'BB%', numeric: true, fmt: (v) => (v == null ? '—' : `${v.toFixed(1)}%`) },
  { key: 'kbbPct', label: 'K-BB%', numeric: true, fmt: (v) => (v == null ? '—' : `${v.toFixed(1)}%`) },
]
